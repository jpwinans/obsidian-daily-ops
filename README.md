...
- **Add a skill** — drop a directory at `.claude/skills/<group>/<name>/` containing `SKILL.md` with frontmatter (`name`, `description`, `model`, `allowed-tools`). It auto-appears as `/group:name` in the slash menu.
